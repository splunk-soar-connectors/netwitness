...
This table lists the configuration variables required to operate NetWitness Logs and Packets. These variables are specified when configuring a NetWitness Logs and Packets asset in Splunk SOAR.
